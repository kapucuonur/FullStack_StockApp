...
async function seed() {
    try {
        ...
        // Purchases (create a couple of records)
        await upsert(Purchase, { productId: product1._id, userId: admin._id }, {
            userId: admin._id,
            firmId: firm1._id,
            brandId: brand1._id,
        ...
        await upsert(Purchase, { productId: product2._id, userId: staff._id }, {
            userId: staff._id,
            firmId: firm2._id,
            brandId: brand2._id,
        ...
        // Sales
        await upsert(Sale, { productId: product1._id, userId: test._id }, {
            userId: test._id,
            brandId: brand1._id,
            productId: product1._id,
            quantity: 10,
        ...
        await upsert(Sale, { productId: product2._id, userId: test._id }, {
            userId: test._id,
            brandId: brand2._id,
            productId: product2._id,
            quantity: 20,
